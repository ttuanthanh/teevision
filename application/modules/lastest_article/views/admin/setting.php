...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('lastest_article/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('lastest_article')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm validate required" name="title" placeholder="<?php echo lang('title');?>" value="<?php echo $lastest_article->title; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('lastest_article_admin_setting_title_validate');?>"> 
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('lastest_article_admin_setting_show_title');?></label>
						<?php
							$show_title = array(
								'yes'=>lang('yes'),
								'no'=>lang('no'),
					...
					<div class="col-sm-6">
						<label><?php echo lang('lastest_article_admin_setting_show_date');?></label>
						<?php
							$show_date = array(
								'yes'=>lang('yes'),
								'no'=>lang('no'),
							...
							if(isset($options->show_date))
								...
								$default = '';
							echo form_dropdown('options[show_date]', $show_date, $default, 'class="form-control input-sm"');
						?>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('lastest_article_admin_setting_show_thumb');?></label>
						<?php
							$show_thumb = array(
								'yes'=>lang('yes'),
								'no'=>lang('no'),
							);
							if(isset($options->show_thumb))
								$default = $options->show_thumb;
							else
								$default = '';
							echo form_dropdown('options[show_thumb]', $show_thumb, $default, 'class="form-control input-sm"');
						?>
					</div>
					
					<div class="col-sm-6">
						<label><?php echo lang('lastest_article_admin_setting_show_intro_text');?></label>
						<?php
							$show_intro = array(
								'yes'=>lang('yes'),
								'no'=>lang('no'),
							);
							if(isset($options->show_intro))
								$default = $options->show_intro;
							else
								$default = '';
							echo form_dropdown('options[show_intro]', $show_intro, $default, 'class="form-control input-sm"');
						?>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('lastest_article_admin_setting_count_article_title');?></label>
						<input type="text" name="options[count]" class="form-control input-sm" value="<?php if(isset($options->count) && $options->count != '') echo $options->count; else echo 4; ?>" placeholder="<?php echo lang('lastest_article_admin_setting_count_article_title');?>"/>
					</div>
					
					<div class="col-sm-6">
						<label><?php echo lang('lastest_article_admin_setting_class_sfx');?></label>
						<input type="text" name="options[class_sfx]" class="form-control input-sm" value="<?php if(isset($options->class_sfx)) echo $options->class_sfx;?>" placeholder="<?php echo lang('lastest_article_admin_setting_class_sfx');?>"/>
					</div>
				</div>
			</div>
		</div>
		...
		<!-- design options -->
		<?php 
			$params = json_decode($lastest_article->params, true);
		?>
