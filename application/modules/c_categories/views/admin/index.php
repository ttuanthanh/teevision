...
<div class="form-group col-md-12 text-right">
	...
	<a class="btn btn-primary" href="javascript:void(0)" onclick="grid.module.setting('c_categories', '')">
				...
				<?php 
					if(count($categoriess) > 0)
					{
						...
						<tr>
							...
							<td>
								<a title="Click to choose this module" href="javascript:void(0)" onclick="grid.module.insert('c_categories', 'index', <?php echo $categories->id; ?>, '<?php echo $categories->key; ?>', '<?php echo $categories->title; ?>')">
									<?php echo $categories->title; ?>
								</a>
							</td>
							<td><?php echo $categories->key; ?></td>
							<td class="center"><i class="fa fa-pencil-square-o" onclick="grid.module.setting('c_categories', <?php echo $categories->id; ?>)" style="cursor: pointer;"></i><span class="page_ajax"><a href="<?php echo site_url().'c_categories/admin/setting/remove/'.$categories->id;?>"><i class="glyphicon glyphicon-remove" style="margin-left: 5px; color: #D9534F;"></i></span></td>
						</tr>
					<?php } ?>
				<?php } ?>
