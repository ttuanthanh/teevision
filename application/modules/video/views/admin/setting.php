...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('video/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('video')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm validate required" name="title" placeholder="<?php echo lang('title');?>" value="<?php echo $video->title; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('video_admin_setting_title_validate');?>"> 
			</div>
			...
			<div class="form-group">
				<label><?php echo lang('video_admin_setting_source_code_title');?></label>
				<input type="text" class="form-control input-sm" name="data[url]" value="<?php if(isset($content->url)) echo $content->url; ?>" placeholder="<?php echo lang('video_admin_setting_source_code_title');?>">
				<span class="help-block"><?php echo lang('video_admin_setting_url_help');?></span>
			</div>
			
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('video_admin_setting_width_title');?></label>
						<input type="text" class="form-control input-sm" name="data[width]" value="<?php if(isset($content->width)) echo $content->width; ?>" placeholder="<?php echo lang('video_admin_setting_width_title');?>">
					</div>
					
					<div class="col-sm-6">
						<label><?php echo lang('video_admin_setting_height_title');?></label>
						<input type="text" class="form-control input-sm" name="data[height]" value="<?php if(isset($content->height)) echo $content->height; ?>" placeholder="<?php echo lang('video_admin_setting_height_title');?>">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('video_admin_setting_responsive_title');?></label>
						<?php
							$responsive = array(
								'yes'=>lang('yes'),
								'no'=>lang('no'),
							);
							if(isset($content->responsive) && $content->responsive != '')
								$default = $content->responsive;
							else	
								$default = '';
							echo form_dropdown('data[responsive]', $responsive, $default, 'class="form-control input-sm"');
						?>
					</div>
					
					<div class="col-sm-6">
						<label><?php echo lang('video_admin_setting_class_sfx_title');?></label>
						<input type="text" name="data[class_sfx]" class="form-control input-sm" value="<?php if(isset($content->class_sfx)) echo $content->class_sfx; ?>" placeholder="<?php echo lang('video_admin_setting_class_sfx_title');?>"/>
					</div>
				</div>
			</div>
		</div>
