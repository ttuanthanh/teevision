...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('m_contact/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('m_contact')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    		
	</ul>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			<div class="form-group">
				<label><?php echo lang('contact_admin_setting_title');?><span class="symbol required"></span></label>
				<input type="text" class="form-control input-sm validate required" name="title" placeholder="<?php echo lang('contact_admin_setting_title_place');?>" value="<?php echo $contact->title; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('contact_admin_setting_title_validate');?>"> 
			</div>
			
			<div class="form-group">
				<label><?php echo lang('contact_admin_setting_your_email_title');?><span class="symbol required"></span></label>
				<input type="text" class="form-control input-sm validate required" name="email" placeholder="<?php echo lang('contact_admin_setting_your_email_place');?>" value="<?php echo $contact->email; ?>" data-type="email" data-msg="<?php echo lang('contact_admin_setting_your_email_validate');?>"> 
				<p class="help-block"><?php echo lang('contact_admin_setting_your_email_eg');?></p>
			</div>
			
			<div class="form-group">
				<label><?php echo lang('contact_admin_setting_subject_title');?></label>
				<input type="text" class="form-control input-sm" name="subject" placeholder="<?php echo lang('contact_admin_setting_subject_place');?>" value="<?php echo $contact->subject; ?>"> 
				<p class="help-block"><?php echo lang('contact_admin_setting_subject_short_code_eg');?></p>
			</div>
			
			<div class="form-group">
				<label><?php echo lang('contact_admin_setting_message_title');?></label>
				<textarea class="text-edittor" name="message" rows="10"><?php echo $contact->message; ?></textarea>
				<p class="help-block"><?php echo lang('contact_admin_setting_message_short_code_eg');?></p>
			</div>
			
			<div class="form-group">
				<label><?php echo lang('contact_admin_setting_copy_email_title');?></label><br/>
				<input type="checkbox" name="copy" id="copy_email" value="1" <?php if($contact->copy == 1) echo 'checked=""'; ?>> <label for="copy_email" style="color: #666;"><?php echo lang('contact_admin_setting_copy_email_send');?></label>
			</div>
