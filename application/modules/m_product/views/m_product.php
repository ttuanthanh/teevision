...
if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	if(count($products))
	{
		...
		//echo '<pre>';
		//print_r($products);
		echo'<div class="contain-btn-inform row mobile"><div class="col-xs-6 inform-btn-mobile mobile"><a href="/design-online" class="col-xs-12 btn btn-warning inform-link"><span>Start Design</span></a></div>';
