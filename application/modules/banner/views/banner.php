...
<ul class="bxslider top-banner">
	<?php 
		...
		{
			if(isset($captions[$i]))
				echo '<li><a href="/design-online"><img src="'.base_url($images[$i]).'" alt="image"/><div class="bx-caption">'.$captions[$i].'</div></a></li>';
			else
				echo '<li><a href="/design-online"><img src="'.base_url($images[$i]).'" alt="image"/></a></li>';
		}
	?>
</ul>
