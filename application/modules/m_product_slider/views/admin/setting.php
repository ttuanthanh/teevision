...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('m_product_slider/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('m_product_slider')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm validate required" name="title" placeholder="<?php echo lang('title');?>" value="<?php echo $hilight->title; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('maps_admin_setting_title_validate');?>"> 
			</div>
		...
		<!-- design options -->
		<?php 
			$params = json_decode($hilight->params, true);
		?>
