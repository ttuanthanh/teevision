...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('m_cart/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('m_cart')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm validate required" name="title" placeholder="<?php echo lang('title');?>" value="<?php echo $m_cart->title; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('m_cart_admin_setting_title_validate');?>"> 
			</div>
		</div>
		
		<!-- design options -->
		<?php 
			$params = json_decode($m_cart->params, true);
		?>
