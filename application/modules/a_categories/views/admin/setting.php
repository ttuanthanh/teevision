...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('a_categories/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('a_categories')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
