...
<form name="setting" class="setting-save" method="POST" action="<?php echo site_url('maps/admin/setting/save/'.$id); ?>">
<div class="tabpanel" role="tabpanel">
	...
	<ul class="nav nav-tabs" role="tablist">
		...
		<li class="button-back pull-right"><a href="javascript:void(0)" onclick="grid.module.setting('maps')" title="Back to list"><i class="clip-arrow-left-2"></i></a></li>    
	</ul>
	...
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="tab-general">	
			<div class="form-group">
				...
				<input type="text" class="form-control input-sm validate required" name="title" placeholder="<?php echo lang('title');?>" value="<?php echo $maps->title; ?>" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('maps_admin_setting_title_validate');?>"> 
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('maps_admin_setting_latitude_title');?></label>
						<input type="text" class="form-control input-sm" name="data[latitude]" placeholder="<?php echo lang('maps_admin_setting_latitude_title');?>" value="<?php if(isset($content->latitude) && $content->latitude != '') echo $content->latitude; else echo 40.713202;?>"> 
					</div>
					<div class="col-sm-6">
						<label><?php echo lang('maps_admin_setting_longitude_title');?></label>
						<input type="text" class="form-control input-sm" name="data[longitude]" placeholder="<?php echo lang('maps_admin_setting_longitude_title');?>" value="<?php if(isset($content->longitude) && $content->longitude != '') echo $content->longitude; else echo -73.992041;?>"> 
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('maps_admin_setting_width_title');?></label>
						<input type="text" class="form-control input-sm" name="data[width]" placeholder="<?php echo lang('maps_admin_setting_width_title');?>" value="<?php if(isset($content->width)) echo $content->width; ?>"> 
					</div>
					<div class="col-sm-6">
						<label><?php echo lang('maps_admin_setting_height_title');?></label>
						<input type="text" class="form-control input-sm" name="data[height]" placeholder="<?php echo lang('maps_admin_setting_height_title');?>" value="<?php if(isset($content->height)) echo $content->height; else echo 300; ?>">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="row">
					<div class="col-sm-6">
						<label><?php echo lang('maps_admin_setting_zoom_title');?></label>
						<input type="text" class="form-control input-sm" name="data[zoom]" placeholder="<?php echo lang('maps_admin_setting_zoom_title');?>" value="<?php if(isset($content->zoom) && $content->zoom != '') echo $content->zoom; else echo 8;?>"> 
					</div>
					
					<div class="col-sm-6">
						<label><?php echo lang('maps_admin_setting_map_type_title');?></label>
						<?php
							$maptype = array(
								'ROADMAP'=>lang('maps_admin_setting_roadmap'),
								'SATELLITE'=>lang('maps_admin_setting_satellite'),
								'HYBRID'=>lang('maps_admin_setting_hybrid'),
								'TERRAIN'=>lang('maps_admin_setting_terrain'),
							);
							if(isset($content->maptype) && $content->maptype != '')
								$default = $content->maptype;
							else	
								$default = '';
							echo form_dropdown('data[maptype]', $maptype, $default, 'class="form-control input-sm"');
						?>
					</div>
				</div>
			</div>
		...
		<!-- design options -->
		<?php 
			$params = json_decode($maps->params, true);
		?>
