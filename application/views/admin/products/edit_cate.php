...
<link href="<?php echo base_url('assets/plugins/jquery-fancybox/jquery.fancybox.css'); ?>" rel="stylesheet"/>
    ...
    echo form_open(site_url() . 'admin/products/categoryedit/'.$id, $attribute);
    ?>
	 <?php if ($error != '') { ?> 
	...
	<div class="row">
		<div class="col-sm-12">
			<p class="pull-right">
				...
				<a class="btn btn-danger" href="<?php echo site_url().'admin/products/categories'; ?>"><?php echo lang('close'); ?></a>
			</p>
		</div>
	</div>
	<div class="panel panel-default">
		<div class="panel-heading">
			...
			<?php if($id != '') echo lang('products_edit_category_edit_category'); else echo lang('products_add_category_add_category');?>		   
		</div>
		<div class="modal-body">	
		
			<div class="row">
				<div class="col-sm-6">
					<h4><?php echo lang('products_edit_category_category_info'); ?></h4>
					<hr/>
					<div class="form-group">
						<div class="col-sm-10">
							...
							<input type="text" class="form-control validate required" name="data[title]" data-minlength="2" data-maxlength="200" data-msg="<?php echo lang('products_edit_category_validate_title_msg');?>" placeholder="<?php echo lang('products_edit_category_title_place');?>" value="<?php echo set_value('data[title]', $category->title); ?>"/>
							<small><i style="color: #858585;"><?php echo lang('products_edit_category_title_note');?></i></small>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" name="data[slug]" placeholder="<?php echo lang('products_edit_category_slug_place');?>" value="<?php echo set_value('data[slug]', $category->slug); ?>"/>
							<small><i style="color: #858585;"><?php echo lang('products_edit_category_slug_note');?></i></small>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-10">
							<label>
								<?php echo lang('page_layout'); ?></span>
							</label>
							<select class="form-control" name="data[layout]">
								...
								<?php if (count($layouts) > 0) { ?>
									...
									foreach($layouts as $layout) {
										if ($category->layout == $layout->id) $selected = 'selected="selected"';
										else $selected = '';
									?>
									<option <?php echo $selected; ?> value="<?php echo $layout->id; ?>"> <?php echo $layout->title; ?> </option>
									<?php } ?>
					...
					<div class="form-group">
						<div class="col-sm-4">
							<label><?php echo lang('products_edit_category_parent_category'); ?></label>
							<?php 
				...
				<div class="col-sm-6">
					<h4><?php echo lang('products_edit_category_meta_info'); ?></h4>
					<hr/>
					<div class="form-group">
						<div class="col-sm-11">	
							<label><?php echo lang('products_edit_category_meta_title'); ?></label>
							<textarea class="form-control" name="data[meta_title]" placeholder="<?php echo lang('products_edit_category_meta_title_place');?>" ><?php echo set_value('data[meta_title]', $category->meta_title); ?></textarea>
							<small><i style="color: #858585;"><?php echo lang('products_edit_category_meta_title_note');?></i></small>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-11">	
							...
							<textarea class="form-control" name="data[meta_keyword]" placeholder="<?php echo lang('products_edit_category_meta_keyword_place');?>" ><?php echo set_value('data[meta_keyword]', $category->meta_keyword); ?></textarea>
							<small><i style="color: #858585;"><?php echo lang('products_edit_category_meta_keyword_note');?></i></small>
						</div>
					</div>
					...
					<div class="form-group">
						<div class="col-sm-11">	
							...
							<textarea class="form-control" name="data[meta_description]" placeholder="<?php echo lang('products_edit_category_meta_description_place');?>" ><?php echo set_value('data[meta_description]', $category->meta_description); ?></textarea>
							<small><i style="color: #858585;"><?php echo lang('products_edit_category_meta_description_note');?></i></small>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-12">
					...
					<small><i style="color: #858585;"><?php echo lang('products_edit_category_description_note');?></i></small>
				</div>
			</div>
		</div>
	</div>
