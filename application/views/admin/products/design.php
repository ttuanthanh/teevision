...
<div class="modal-dialog modal-lg" id="product-designer">
	<div class="modal-content">
					...
					<ul class="colors">
						<li>							
							<a href="javascript:void(0);" class="box-color margin-top">
								<span style="background-color:#<?php echo $color; ?>" class="color-bg"></span> <?php echo $title; ?>
							</a>
						</li>
					</ul>
				</div>
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div class="design-tools row col-md-12">
						...
						<a href="javascript:void(0)" title="" onclick="jQuery.fancybox( {href : '<?php echo site_url('/admin/media/modals/design/2') ?>', type: 'iframe'} );"><i class="clip-upload"></i> <?php echo lang('product_change_design');?></a>
					</div>
					<br>
					<div class="row">
						<div class="col-md-12">
		...
		<div class="modal-footer">			
			<button type="button" class="btn btn-primary white" onclick="dgUI.product.save('<?php echo $position; ?>', '<?php echo $color; ?>')"><?php echo lang('save'); ?></button>
