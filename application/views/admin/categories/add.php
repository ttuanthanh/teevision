	...
	<div class="form-group">
		...
		<div class="col-sm-10">	
			<select name="cateLang[parent_id]" class="form-control form-control input-sm" id="product-category-parent">
				...
				<?php echo dispayTree( $categories, 0, array('type'=>'select', 'name'=>''), array($parent_id) ); ?>
			</select>			
		</div>
	</div>	
	...
	<div class="tab-content" id="tab-content-lang">
		<div id="en" class="tab-pane active">			
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" placeholder="<?php echo lang('add_title'); ?>" class="form-control" name="cateLang[title]">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><?php echo lang('slug'); ?></label>
				<div class="col-sm-6">
					<input type="text" placeholder="<?php echo lang('add_slug'); ?>" class="form-control" name="cateLang[slug]">
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label"><?php echo lang('description'); ?></label>
				<div class="col-sm-10">
					<textarea placeholder="<?php echo lang('add_description'); ?>" class="form-control textarea-tinymce" name="cateLang[description]"></textarea>
				</div>
			</div>
		</div>
	</div>
...
<input type="hidden" value="<?php echo $clip_id; ?>" name="clip_id">
<?php echo form_close(); ?>