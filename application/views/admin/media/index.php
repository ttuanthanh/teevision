	...
	<div id="dag-files">
		<div class="dag-files-head">
			...
			<div class="action">
				...
				<a href="javascript:void(0)" class="pull-right" title="" onclick="">
					<i class="clip-grid"></i>
				</a>
				...
				<?php if($folders) { ?>
					...
					<span class="view-thumb view-folder" data-path="<?php echo DS . $root .DS. $folder; ?>">
						...
						<span class="file-tool">
							<a href="javascript:void(0)" title="Edit" onclick="dagFiles.folder.rename('<?php echo DS . $root .DS. $folder; ?>', '<?php echo $folder; ?>');"><i class="clip-pencil-3"></i></a>
							<a href="javascript:void(0)" title="Remove" onclick="dagFiles.folder.remove('<?php echo DS . $root .DS. $folder; ?>', this);"><i class="glyphicon glyphicon-trash"></i></a>
						</span>
					</span>
					<?php } ?>
