                    ...
                    ?>
                        <div class="col-md-12">
                            ...
                            <div class="row-content clearfix col-sm-5">                                
                                ...
                                <a href="<?php echo site_url('admin/artworkschedule/download_zip/'.$artwork->id) ?>" class="btn btn-primary">Download zip</a>
                                        ...
                                        <div class="col-xs-8 ship-date">
                                            <?php //var_dump($product->artworkSchedule); ?>
                                                ...
                                                <div class="form-group">
                                                    <textArea readonly="true" placeholder="Enter your comment..." rows="4" class="form-control" id="art_comment" name="art_comment"><?php echo isset($product->artworkSchedule->art_comment) ?  $product->artworkSchedule->art_comment : ''?></textArea>
                                                </div>
