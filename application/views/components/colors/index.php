...
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><?php echo lang('select_color'); ?></h4>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<select id="color-type" class="form-control" onchange="dgUI.product.color.find('', this)">
						...
						<option value="basic"><?php echo lang('basic');?></option>
						<option value="general"><?php echo lang('general');?></option>
					</select>
				</div>
			</div>
			<br />
