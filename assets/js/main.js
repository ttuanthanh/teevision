function login(e, t) {
    ...
    if (e == "logged") {
        ...
        action = baseURL + "users/change_pass"
    } else {
            ...
            success: function(n) {
                if (n != "") {
                    ...
                    if (n != 1) {
                        ...
                        r += "</li>";
                        r += "<li>";
                        r += '<a href="' + baseURL + 'users/logout">' + logOut + "</a>";
                        r += "</li>";
