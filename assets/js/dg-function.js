		...
		field: function(e, type){
			...
			if(type == 'add')
			{
				...
				var html = '<div class="row form-group row-fields">'
						...
						+ 	'<input type="text" name="product[fields]['+id+'][prices_color][]" class="form-control input-sm">'
						+ '</div>'
                                                + '<div class="col-md-3 pull-right">'
		...
		attribute: function(type){
			if(type == 'add')
			{
				...
				var html = '<div class="panel panel-simple" data-attribute="'+id+'">'
							...
							+					'<div class="col-md-3 pull-right">Price Color</div>'							
                                                        +                                       '<div class="col-md-3 pull-right">Price White</div>'	
							+					'<div class="col-md-4 pull-right">Title</div>'							
							+				'</div>'							
							+			'</div>'							
							+		'</div>'							
							+	'</div>'							
